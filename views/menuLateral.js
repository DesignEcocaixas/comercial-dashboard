module.exports = (usuario) => {
    ...
    if (isAdmin) {
        links = `
            ...
            <a href="#" class="nav-link text-light mb-1" data-bs-toggle="modal" data-bs-target="#modalZerarCiclo"><i class="fa-solid fa-rotate-right me-2 text-primary"></i> Fechar mês</a>
        `;
    } else {
        links = `
            <style>
