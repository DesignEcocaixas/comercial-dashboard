...
module.exports = (usuarioLogado, usuarios, metas, kpis, metaGlobal, alcancadoGlobal, todosClientes = []) => {
    ...
    return layout(`
            ...
            <div style="width: 85%; margin: 0 auto; font-size: 0.9rem; padding-top: 1rem;">
...
>
  <i class="fa-solid fa-circle-check me-1"></i> Fechar meta
        ...
        <div class="card shadow-sm rounded-3 border mb-3">
    ...
    @media (max-width: 991.98px) {
        ...
        <div class="container-70">
            <div class="card shadow-sm rounded-3 border mb-5 animate-up" style="animation-delay: 0.4s;">
                ...
                <div class="bg-light p-2 rounded border border-light-subtle shadow-sm">
                    <form action="/admin/exportar-clientes" method="GET" class="row g-2 align-items-center m-0 flex-nowrap">
                        <div class="col-auto d-flex align-items-center">
                            <span class="small fw-bold text-muted mb-0">
                                <i class="fa-solid fa-download text-success me-1"></i> Exportar Dados:
                            </span>
                        </div>
                        
                        <div class="col-auto">
                            <select name="vendedor_id" class="form-select form-select-sm border-secondary-subtle" style="width: 100px;" required>
                        ...
                        <div class="col-auto ms-auto">
                            <button type="submit" class="btn btn-sm btn-success fw-bold">
                                <i class="fa-solid fa-file-excel me-1"></i> Baixar Tabela
                            </button>
                        </div>
                    </form>
                </div>
                                ...
                                <tr class="cliente-admin-row" data-busca="${(c.nome + ' ' + (c.vendedor_nome || '') + ' ' + (c.regiao || '')).toLowerCase()}">
                                    ...
                                    <td>
                                        <div class="d-flex flex-column gap-1" style="max-width: 110px;">
                                            ...
                                            ${c.fechou === 'sim' ? 
                                                (c.pos_venda === 'sim' ? '<span class="badge bg-success-subtle text-success border border-success-subtle w-100 text-start fw-normal" style="font-size: 0.7rem;"><i class="fa-solid fa-headset me-1"></i> Pós: Sim</span>' : 
                                                 c.pos_venda === 'nao' ? '<span class="badge bg-danger-subtle text-danger border border-danger-subtle w-100 text-start fw-normal" style="font-size: 0.7rem;"><i class="fa-solid fa-headset me-1"></i> Pós: Não</span>' : 
                                                 '<span class="badge bg-warning-subtle text-warning border border-warning-subtle w-100 text-start fw-normal" style="font-size: 0.7rem;"><i class="fa-solid fa-headset me-1"></i> Pós: Pend.</span>') 
                                            : ''}

                                            ${c.carteira === 'sim' ? 
                                                (c.comprou_recorrente === 'sim' ? '<span class="badge bg-info-subtle text-info border border-info-subtle w-100 text-start fw-normal" style="font-size: 0.7rem;"><i class="fa-solid fa-cart-shopping me-1"></i> Comprou</span>' : 
                                                 '<span class="badge bg-secondary-subtle text-secondary border border-secondary-subtle w-100 text-start fw-normal" style="font-size: 0.7rem;"><i class="fa-solid fa-cart-shopping me-1"></i> Inativo</span>') 
                                            : ''}
                                        </div>
                                    </td>
                ...
                <form action="/admin/metas" method="POST">
                    ...
                    <div class="modal-body row">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="number" step="0.01" name="meta_geral" class="form-control" value="${metas.ecommerce.meta_geral || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">QTD Prospecção sem visita</label>
                            <input type="number" name="qtd_prosp_sem_visita" class="form-control" value="${metas.ecommerce.qtd_prosp_sem_visita || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">QTD Prospecção com visita</label>
                            <input type="number" name="qtd_prosp_com_visita" class="form-control" value="${metas.ecommerce.qtd_prosp_com_visita || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">QTD Clientes p/ fechar (Não Fechou)</label>
                            <input type="number" name="qtd_clientes_fechar" class="form-control" value="${metas.ecommerce.qtd_clientes_fechar || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">QTD Cliente Grande (>5k)</label>
                            <input type="number" name="qtd_cliente_grande" class="form-control" value="${metas.ecommerce.qtd_cliente_grande || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">Valor Total Cliente Grande (R$)</label>
                            <input type="number" step="0.01" name="valor_cliente_grande" class="form-control" value="${metas.ecommerce.valor_cliente_grande || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">QTD Pós venda feito</label>
                            <input type="number" name="qtd_pos_venda" class="form-control" value="${metas.ecommerce.qtd_pos_venda || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">QTD Visitas da carteira</label>
                            <input type="number" name="qtd_visitas_carteira" class="form-control" value="${metas.ecommerce.qtd_visitas_carteira || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">QTD Reativações</label>
                            <input type="number" name="qtd_reativacoes" class="form-control" value="${metas.ecommerce.qtd_reativacoes || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">Vendas Outras Regiões</label>
                            <input type="number" name="qtd_vendas_outras_regioes" class="form-control" value="${metas.ecommerce.qtd_vendas_outras_regioes || 0}">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success"><i class="fa-solid fa-check me-1"></i> Salvar Metas E-commerce</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <form action="/admin/metas" method="POST">
                    ...
                    <div class="modal-body row">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="number" step="0.01" name="meta_geral" class="form-control" value="${metas.industria.meta_geral || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">QTD Prospecção sem visita</label>
                            <input type="number" name="qtd_prosp_sem_visita" class="form-control" value="${metas.industria.qtd_prosp_sem_visita || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">QTD Prospecção com visita</label>
                            <input type="number" name="qtd_prosp_com_visita" class="form-control" value="${metas.industria.qtd_prosp_com_visita || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">QTD Clientes p/ fechar (Não Fechou)</label>
                            <input type="number" name="qtd_clientes_fechar" class="form-control" value="${metas.industria.qtd_clientes_fechar || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">QTD Cliente Grande (>15k)</label>
                            <input type="number" name="qtd_cliente_grande" class="form-control" value="${metas.industria.qtd_cliente_grande || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">Valor Total Cliente Grande (R$)</label>
                            <input type="number" step="0.01" name="valor_cliente_grande" class="form-control" value="${metas.industria.valor_cliente_grande || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">QTD Pós venda feito</label>
                            <input type="number" name="qtd_pos_venda" class="form-control" value="${metas.industria.qtd_pos_venda || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">QTD Visitas da carteira</label>
                            <input type="number" name="qtd_visitas_carteira" class="form-control" value="${metas.industria.qtd_visitas_carteira || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">QTD Reativações</label>
                            <input type="number" name="qtd_reativacoes" class="form-control" value="${metas.industria.qtd_reativacoes || 0}">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label small text-muted mb-0">Taxa de Retenção Mínima (%)</label>
                            <input type="number" step="0.01" name="taxa_retencao" class="form-control" value="${metas.industria.taxa_retencao || 0}">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-warning"><i class="fa-solid fa-check me-1"></i> Salvar Metas Indústria</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/admin/meta-global" method="POST">
                    <div class="modal-header bg-dark text-white"><h5 class="modal-title"><i class="fa-solid fa-globe me-2"></i> Definir Meta Global da Empresa</h5></div>
                    <div class="modal-body">
                        <label class="form-label text-muted">Qual é a meta de faturamento coletivo? (R$)</label>
                        <input type="number" step="0.01" name="valor" class="form-control form-control-lg" value="${metaGlobal}" required>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-dark"><i class="fa-solid fa-check me-1"></i> Salvar Meta Global</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body overflow-auto p-0">
                    <table class="table align-middle table-hover mb-0">
                        <thead class="bg-light">
                            <tr>
                                <th class="ps-4">Foto</th><th>Nome</th><th>Setor</th><th>Tipo</th><th class="text-end pe-4">Ações</th>
                            </tr>
                        </thead>
                        <tbody>
                            ${usuarios.map(u => `
                ...
                <div class="modal-content">
                    <form action="/admin/usuario/editar" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <label class="form-label small text-muted mb-0 mt-2">Nova Foto (Deixe vazio para manter a atual)</label>
                            <input type="file" name="foto" class="form-control mb-3" accept="image/png, image/jpeg, image/jpg">
                            
                            <label class="form-label small text-muted mb-0">Tipo de Perfil</label>
                            <select name="tipo" class="form-select mb-2">
                            ...
                            <label class="form-label small text-muted mb-0 mt-2">Setor</label>
                            <select name="setor" class="form-select mb-2">
                ...
                <div class="modal-content">
                    <form action="/admin/usuario/excluir" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <p class="text-danger small"><i class="fa-solid fa-circle-exclamation me-1"></i> <strong>Aviso:</strong> Todos os clientes e pontos vinculados a este vendedor serão apagados permanentemente!</p>
                        </div>
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#modalGerenciarUsuarios"><i class="fa-solid fa-arrow-left me-1"></i> Voltar</button>
